...
<body>
    ...
    <div class="body ">
            <div class="login">
                ...
                <h1>Login</h1>         
                <br> <input type="text" placeholder="Email address" name ="loginUsername">
                <br><input id="pass" type="password" placeholder="Password" name="loginPassword">
                <img onclick="showpass()" src="assets/eye.png" alt="eye">
                <br> <a style="margin-left: 25px;" href="ForgotPass.jsp">Forgot password?</a>
                <p class = "errorMessage" style="margin-left: -40px; color: red;">${requestScope.errorMessageLogin}</p>
                <input class="button" type="submit" value="login" name="btnLogin">
                <br><span class="text-dark">Not a member ?</span><a href="Register.jsp"> Signup now</a>
                </form>
            </div>
    </div>
