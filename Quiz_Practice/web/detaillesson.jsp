    ...
    <body>
        ...
        <div class="jumbotron jumbotron-fluid page-header position-relative overlay-bottom" style="margin-bottom: 90px;">
            <div class="container text-center py-5">
                <h1 class="text-white display-1">Lesson</h1>
...
<div id="contanner">
    <div id="option1">
        ...
        <h1>${lesson.getDescription_lesson()}</h1>

        <p style="font-size: 20px ;line-height: 35px;">

        </p>
        <c:forEach var="q" items="${quiz}">  
        <c:if test="${sessionScope.user.roleId == 3 || sessionScope.user.roleId == 1|| sessionScope.user.roleId==2}">
            <form action="takequiz" method="get" style="margin-bottom: 30px">
                <h3>Quiz: ${q.getName_quiz()}</h3>
                <input type="hidden" value="${q.getId_quiz()}" name="qid">
                <input type="hidden" value="${sessionScope.user.idUser}" name="idUser">
                <input style="cursor: pointer;" type="submit" value="Take Quiz" name="accessquiz">
            </form>
        </c:if> 
        </c:forEach>
    </div>
