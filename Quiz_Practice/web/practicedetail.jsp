...
<body>
    ...
    <div class="jumbotron jumbotron-fluid page-header position-relative overlay-bottom" style="margin-bottom: 90px;">
        <div class="container text-center py-5">
            <h1 class="text-white display-1">Practice Details</h1>
    ...
    <form  action="">
        <div class="save">
            ...
            <div>
                <label>Subject Practice</label>
                <input style="border: 1px solid #000 ; height: 25px; width: 70%;" value="Math" >
            </div>
            
            <div>
                <label>Number of question</label>
                <input style="border: 1px solid #000 ; height: 25px; width: 70%;"  value="number" >
            </div>
    
            <div>
                 <label>Lesson Practice</label>
                <input style="border: 1px solid #000 ; height: 25px; width: 70%;" type="number" value="number" >
            </div>
            <input style="width: 30%; height: 35px; border-radius: 3px; border: 1px solid #000;" type="submit" value="Practice">
        </div>
    </form>
</div>
