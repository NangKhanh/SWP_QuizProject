...
<html lang="en">
    ...
    <body>
        ...
        <div class="jumbotron jumbotron-fluid page-header position-relative overlay-bottom" style="margin-bottom: 0px;">
            <div class="container text-center py-5">
                ...
                <h1 class="text-white display-1">Security Code</h1>
            </div>
    ...
    <div class="body">
        ...
        <div class="register ju">
            <form id="register" action="checkUserEmailCode" method = "post">
                <div class="mr-5 detail ">
                    <h5 class="mr-5 text-lg-center ">Vui lòng kiểm tra mã trong email của bạn </h5>
                    <div class="d-flex flex-row mt-3 mr-3">
                        <input placeholder="Nhập mã" type="text" name="email_code" autofocus />
                    </div>
                </div>
                <p class = "errorMessage" style="color: red;">${requestScope.errorMessage}</p>
                <br><input type="submit" onclick="validate()" class="button ml-5" value="Continue" readonly>
                <br><span class="text-danger" id="mess"></span>
