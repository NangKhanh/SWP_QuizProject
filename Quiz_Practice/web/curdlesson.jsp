    ...
    <div class="">
        <ul class="nav nav-tabs" id="myTab" role="tablist" style="margin-bottom: 20px;">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="home-tab" data-toggle="tab" data-target="#home" type="button"
                        role="tab" aria-controls="home" aria-selected="true">Lession</button>
            </li>
            <li class="nav-item" role="presentation" style="margin-right: 10px;">
                <button class="nav-link" id="profile-tab" data-toggle="tab" data-target="#profile" type="button"
                        role="tab" aria-controls="profile" aria-selected="false">Add new lession</button>
            </li>
            <button type="button" class="btn btn-primary " data-toggle="modal" data-target="#exampleModal"
                    style="height: 30px; margin: auto 0; border-radius: 10px; padding-top:2px;">
                Add a new subject
            </button>
        </ul>
        ...
        <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade show active " id="home" role="tabpanel" aria-labelledby="home-tab">
                <form action="listlesson" class="container" method="post" id="chooseSubject">
                        ...
                        <tbody>
                            <c:forEach items="${infoLession}" var="lesson">
                                <tr>
                                    ...
                                    <td><a onclick="confirmDelete()" class="text-danger" href="#">Delete</a></td>
            ...
            <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                <form action="crudlesson" method="get" class="container col-11">
                    <div class="d-flex">
                        <div class="d-flex">
                            Subject <select class="form-control"
                                            style="width: 200px; height: 38px;  margin-bottom: 38px; margin-left: 10px;" name="idSubject"
                                            id="">
                                <c:forEach items="${infoSubject}" var="sub">
                                    <option value="${sub.getId_subject()}">${sub.getName_subject()}</option>
                        ...
                        <div class="d-flex" style="margin-left: 20px;">
                            Lession's Name <input class="form-control" type="text" name="lessonName"
                                                  style="width: 200px; height: 38px;  margin-bottom: 38px; margin-left: 10px;">
                        </div>
                        <div class="d-flex" style="margin-left: 20px;">
                            Lession's Description <input class="form-control" type="text" name="lessonDescription"
                                                         style="width: 200px; height: 38px;  margin-bottom: 38px; margin-left: 10px;">
                        </div>
                    </div>
                    <input class="btn btn-primary" type="submit" value="Submit" style="height: 29.2px;  width: 100px;"
                                   readonly>
                </form>
                <form action="" class="container col-11">
                    <div class="">
                        <table id="myTable" class="table">
                            ...
                            <tbody>
                                <tr class="content">
                                    <td scope="row">1</td>
                                    <td><textarea class="form-control" name="col1[]" style="height: 38px;"></textarea>
                                    </td>
                                    <td><input class="form-control" type="text" name="col2[]" /></td>
                                    <td><input class="form-control" type="text" name="col3[]" /></td>
                                    <td><input class="form-control" type="text" name="col4[]" /></td>
                                    <td><input class="form-control" type="text" name="col5[]" /></td>
                                    <td><select class="form-control"
                                                style=" height: 38px;  margin-bottom: 30px; border: 1px solid #000;" name=""
                                                id="">
                        ...
                        <div style="margin-bottom: 35px;">
                            <input id="addRow" class="btn btn-danger" value="+" style="height: 29.2px; width: 50px;"
                                   readonly>
                            <input class="btn btn-primary" value="Submit" style="height: 29.2px;  width: 100px;"
                                   readonly>
                        </div>
                    </div>
                    </div>
