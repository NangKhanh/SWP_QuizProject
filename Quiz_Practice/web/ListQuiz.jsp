        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist" style="margin-bottom: 20px;">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="home-tab" data-toggle="tab" data-target="#home" type="button"
                        role="tab" aria-controls="home" aria-selected="true">Quiz</button>
            </li>
                ...
                <form action="crudquiz" class="container" method="post" id="chooseSubject">
                    <div class="d-flex container">
                        ...
                        <div class="d-flex" style="margin-left: 20px;">
                            ...
                            <a href="AddQuizAndQuestion.jsp?idLesson=${idLesson}" class="btn btn-primary"  value="Add new Quiz" readonly 
                               style=" margin-bottom: 38px; margin-left: 10px;" >Add new Quiz</a>
                        </div>
                    </div>
                </form>
                <table class="table">
                    ...
                    <tbody>
                        <c:forEach items="${infoQuiz}" var="quiz">
                            <tr>
                                <th scope="row">${quiz.getId_quiz()}</th>
                                <td>${quiz.getName_quiz()}</td>
                                <td>${quiz.getDescription_quiz()}</td>
                                <td>${quiz.getQuestion_number()}</td>
                                <td><a href="deletequiz?idQuiz=${quiz.getId_quiz()}">Delete</a></td>
                                <td><a href="updatequiz?idQuiz=${quiz.getId_quiz()}">Update</a></td>
                            </tr>
                        </c:forEach>
