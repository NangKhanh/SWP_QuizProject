<%-- 
    Document   : Score
    Created on : Feb 15, 2023, 9:16:53 AM
    Author     : AD
--%>
...
<html lang="en">
    ...
    <body>
         ...
         <div class="jumbotron jumbotron-fluid page-header position-relative overlay-bottom" style="margin-bottom: 0px;">
            <div class="container text-center py-5">
                <div class="d-inline-flex text-white mb-5">
                    <h1 class="text-white display-1">View Score</h1>
                </div>
            </div>
        </div>
        <!-- Header End -->
        ...
        <div class="container">
            <div class="d-none">
                <input type="text" id="trueVal" value="${count}">
                <input type="text" id="failVal" value="${numberFail}">
            </div>
            ...
            <div>
                <a class="btn btn-primary text-info" href="/quizpractice/reviewQuiz?quizResult=${quizResult}" style="border-radius: 20px;"><h3>View your answers</h3></a>
            </div>
            <div>
    ...
    <script>
        ...
        let trueVal = document.getElementById('trueVal').value;
        let failVal = document.getElementById('failVal').value;
        new Chart(ctx, {
            type: 'bar',
            data: {
                labels: ['Detail value'],
                datasets: [{
                        ...
                        data: [trueVal],
                        borderWidth: 1,
                        backgroundColor: ['rgb(118, 193, 118)']
                    }, {
                        label: 'False answer',
                        data: [failVal],
                        borderWidth: 1,
            ...
            options: {
                ...
                legend: {
                    labels: {
                        color: 'green' // set the color of the legend labels
                    }
                }
            }
        });
