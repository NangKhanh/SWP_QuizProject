...
<html lang="en">
    ...
    <body>
        ...
        <div class="jumbotron jumbotron-fluid page-header position-relative overlay-bottom" style="margin-bottom: 0px;">
            ...
            <h1 class="text-white display-1">Confirm Password</h1>
    ...
    <div class="body">
        ...
        <div class="register">
            <form class="justify-content-center" action = "changePassword" method="post">
                        <div class="form-group row  ">
                            <label for="inputEmail3" class="col-sm-4 col-form-label text-left">New Password: </label>
                            <div class="col-sm-8">
                                <input type="password" class="form-control mt-3" id="inputEmail3" name = "newPassword" required>
                            </div>
                        </div>
