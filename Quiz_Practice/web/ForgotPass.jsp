...
<html lang="en">
    ...
    <body>
        ...
        <div class="jumbotron jumbotron-fluid page-header position-relative overlay-bottom" style="margin-bottom: 0px;">
            ...
            <h1 class="text-white display-1">Forget Pass</h1>
            </div>
        </div>
    </div>
    <!-- Header End -->
    <div class="body">
        ...
        <div class="register">
            <form id="register" action="forgetPassword" method="post">
                <div class="detail">
                    <br><input id="email" name = "email" type="email" placeholder="Email address">
                </div>
                <p class = "errorMessage"style="color: red;">${requestScope.errorMessage}</p>
                <br><input onclick="validate()" class="button" value="Send code" readonly>
    ...
    <script src="js/fogotpassValidate.js"></script>
