                    ...
                    <form action ="search" class="search" method="post">
                        <div class="mx-auto mb-5" style="width: 100%; max-width: 600px;">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control border-light" name = "txt" style="padding: 30px 25px;" placeholder="search subject">
                        ...
                        <nav aria-label="Page navigation">
                            <ul class="pagination pagination-lg justify-content-center mb-0">
                                ...
                                <li class="page-item disabled">
                                    <a class="page-link rounded-0" href="home?currentPage=1" aria-label="Previous">
                                ...
                                <c:forEach begin ="1" end ="${numberOfPages}" var="i">
                                    <li class="page-item active">
                                        <a class="page-link" href="/quizpractice/subcate?grade=${grade}&currentPage=${i}">${i}</a>
                                    </li>      
                                </c:forEach>
                                <li class="page-item">
                                    <a class="page-link rounded-0" href="home?currentPage=${numberOfPages}" aria-label="Next">
