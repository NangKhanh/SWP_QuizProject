...
CREATE TABLE `subjectcategory` (
  ...
  `name_subcate` varchar(50) DEFAULT NULL,
  `description_subcate` varchar(200) DEFAULT NULL,
...
INSERT INTO `subjectcategory` VALUES (1,'Máy tính','Môn học về máy tính'),(2,'Ngôn ngữ','Môn học về ngôn ngữ'),(3,'Logic','Các môn học về tư duy logic');
